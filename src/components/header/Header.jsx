    ...
    return (
        <nav className="navbar bg-body-tertiary p-0">
            <div className="container-fluid border-bottom border-3">
                ...
                <button className="navbar-toggler" type="button" data-bs-toggle="offcanvas" style={{ order: 1}} data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
